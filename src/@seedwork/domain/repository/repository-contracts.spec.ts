...
describe('SearchParams Unit Tests', () => {
    test('page prop', () => {
        ...
        const arrange: { page: any, expect: number }[] = [
            { page: null, expect: 1 },
    ...
    test('per_page prop', () => {
        ...
        const arrange: { per_page: any, expect: number }[] = [
        ...
        arrange.forEach(i => {
            expect(new SearchParams({ per_page: i.per_page }).per_page).toBe(i.expect)
        })
    })
    ...
    test('sort prop', () => {
        ...
        const arrange: { sort: any, expect: any }[] = [
    ...
    test('sort dir prop', () => {
        ...
        const arrange: { sort_dir: any, expect: any }[] = [
        ...
        arrange.forEach(i => {
            expect(new SearchParams({ sort: "field", sort_dir: i.sort_dir }).sort_dir).toBe(i.expect)
        })
    })
    ...
    test('filter prop', () => {
        ...
        const arrange: { filter: any, expect: any }[] = [
